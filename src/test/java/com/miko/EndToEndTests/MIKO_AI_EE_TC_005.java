...
public class MIKO_AI_EE_TC_005 extends BaseClass {


	@Test
	public void MIKO_AI_EE_TC_005_Test()  {
		...
		//click on google pay
		/*
		checkOutInformation.getGoogle_Pay_Btn().click();
		ListenerImplementationClass.test.log(Status.INFO, "navigate to google pay displayed successfully");
		javaUtil.keyPress("esc");    */
